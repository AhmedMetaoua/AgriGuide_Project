"""
Phase B, Day 5 — DL crop-cover classifier service.

Wraps the fine-tuned BreizhCrops TempCNN checkpoint (see
finetune_dl_service.py) into the same parcel-geometry-in,
...
def _load_model():
    ...
    if not os.path.exists(settings.dl_checkpoint_path):
        _model_cache["load_error"] = (
            ...
            f"finetune_dl_service.py and place the resulting .pth file there "
